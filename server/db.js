...
async function createSchema() {
  ...
  // MariaDB no ejecuta de forma fiable este lote de DDL en una sola query sin
  // habilitar explícitamente multi-statements. Ejecutamos cada sentencia por separado.
  for (const statement of statements) {
    await mariaPool.query(statement);
  }
}
